    ...
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          <section className="bg-white border border-[#c3c6ce66] p-8 md:p-12 min-h-[220px] relative overflow-hidden rounded-md">
