...
const configuredOtpLength = Number(process.env.NEXT_PUBLIC_SUPABASE_EMAIL_OTP_LENGTH ?? '6')
const OTP_LENGTH = Number.isFinite(configuredOtpLength) ? Math.min(10, Math.max(6, Math.trunc(configuredOtpLength))) : 6
