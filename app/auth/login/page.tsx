...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fbf9f4] text-[#1b1c19] lg:flex">
      <aside className="hidden lg:flex lg:w-5/12 bg-[#e4e2dd] relative p-16"><div className="flex flex-col justify-between h-full"><span className="font-headline italic text-2xl text-[#00152a]">MYP Atlas</span><div><blockquote className="font-headline text-4xl leading-[1.2] text-[#00152a]">"Education is not the learning of facts, but the training of the mind to think."</blockquote><div className="w-12 h-[2px] bg-[#735b2b] mt-6 mb-4" /><p className="font-body text-xs uppercase tracking-widest text-[#43474d]">Albert Einstein</p></div></div></aside>
      <main className="w-full lg:w-7/12 flex items-center justify-center p-8 sm:p-16 md:p-24">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <button className="w-full bg-[#00152a] text-white py-5 uppercase tracking-widest text-sm" disabled={loading}>{loading ? 'Accessing...' : 'Enter Workspace'}</button>
          </form>
