      ...
      <main className="tsm-shell py-12">
        ...
        <section className="mt-10 grid gap-4 md:grid-cols-2">
          {uniqueSubjects.map((subject) => (
            <Link key={subject.id} href={`/practice/${encodeURIComponent(subject.name)}`} className="cursor-pointer rounded-md border border-[#c3c6ce66] bg-white p-6 transition hover:border-[#735b2b] hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-[#735b2b]/30">
