        ...
        <main className="tsm-shell py-12">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            {visibleChildren.map((child) => (
              <Link key={child.id} href={`/practice/${encodeURIComponent(subject.name)}/${topicRow.id}/${child.id}`} className="cursor-pointer rounded-md border border-[#c3c6ce66] bg-white p-6 transition hover:border-[#735b2b] hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-[#735b2b]/30">
